...
<html lang="en">
    ...
    <body>
        ...
        <div class="mn-content fixed-sidebar">
                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">      
                            <span class="chapter-title">FactEntry | Employee Leave Management </span>
                        </div>
          ...
          <div class="footer">
                    <p class="copyright"><a href="https://www.factentry.com/">FactEntry </a>©</p>
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><h4>Welcome to FactEntry Employee Leave Management System</h4></div>
